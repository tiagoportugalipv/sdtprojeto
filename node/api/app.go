...
func Initialize(nodeCtx context.Context, ipfs iface.CoreAPI, pubSubService *messaging.PubSubService, cidVector []string) {
	...
	fileRoutes.SetUpRoutes(app.Group("/file"), nodeCtx, ipfs, pubSubService, cidVector)
